...
namespace AccountingNavid.Pages.ReportPage
{
    ...
    public partial class ReportFilterDateDetailPage : ContentPage
    {
        public ReportFilterDateDetailPage()
        {
            InitializeComponent();
        }
        protected override void OnAppearing()
        {
            ...
            ToDate.Text = App.ViewModel.DateModel.ToDate.GetValueOrDefault().ToShamsi();
            FromDate.Text = App.ViewModel.DateModel.FromDate.GetValueOrDefault().ToShamsi();
